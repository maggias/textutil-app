    ...
    <ul className="space-y-4">
      <li>
        ...
        <p className="text-sm text-gray-500">
          Converts all characters to uppercase. For example, "hello world"
          becomes "HELLO WORLD".
        </p>
      </li>
      <li>
        ...
        <p className="text-sm text-gray-500">
          Converts all characters to lowercase. For example, "HELLO WORLD"
          becomes "hello world".
        </p>
      </li>
      <li>
        <h4 className="font-medium">Title Case / Capitalized Case</h4>
        <p className="text-sm text-gray-500">
          Capitalizes the first letter of each word. For example, "hello world"
          becomes "Hello World".
        </p>
      </li>
      <li>
        ...
        <p className="text-sm text-gray-500">
          Capitalizes the first letter of each sentence. For example, "hello
          world. how are you?" becomes "Hello world. How are you?".
        </p>
      </li>
      <li>
        <h4 className="font-medium">camelCase</h4>
        <p className="text-sm text-gray-500">
          Combines words without spaces, where the first letter of the first
          word is lowercase and the first letter of each subsequent word is
          uppercase. For example, "hello world" becomes "helloWorld".
        </p>
      </li>
      <li>
        <h4 className="font-medium">PascalCase</h4>
        <p className="text-sm text-gray-500">
          Combines words without spaces, where the first letter of each word is
          uppercase. For example, "hello world" becomes "HelloWorld".
        </p>
      </li>
      <li>
        ...
        <p className="text-sm text-gray-500">
          Replaces spaces with underscores. For example, "hello world" becomes
          "hello_world".
        </p>
      </li>
      <li>
        ...
        <p className="text-sm text-gray-500">
          Replaces spaces with hyphens. For example, "hello world" becomes
          "hello-world".
        </p>
      </li>
      <li>
        ...
        <p className="text-sm text-gray-500">
          Converts all characters to uppercase and replaces spaces with
          underscores. For example, "hello world" becomes "HELLO_WORLD".
        </p>
      </li>
      ...
      <li>
        ...
        <p className="text-sm text-gray-500">
          Alternates between lowercase and uppercase letters. For example,
      ...
      <li>
        ...
        <p className="text-sm text-gray-500">
          Inverts the case of each letter. For example, "Hello World" becomes
          "hELLO wORLD".
        </p>
      </li>
    </ul>
